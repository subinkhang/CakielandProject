            ...
            <div class="row detail">
                ...
                <div class="col-lg-6">
                    <div class="col-12">
                        ...
                        <p class="pr-detail-content">Philips HR3705 Egg Beater (300W) has a compact design with a sturdy
                            handle
                            so you can use it easily without getting tired of your hands after long use. The parts are
                            easily
            ...
            <div class="col-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#des"
                            type="button" role="tab" aria-controls="home" aria-selected="true">DESCRIPTION</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#info"
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="des" role="tabpanel" aria-labelledby="home-tab"
                        ...
                        <ol>
                            ...
                            <p>Philips HR3705 Egg Beater (300W) has a compact design with a sturdy handle so you can use
                                it
                                easily without getting tired of your hands after long-term use. Parts are easily
                                removable and
                                biodegradable in the dishwasher.</p>
                            <li>Turbo function with 5 smart speeds</li>
                            <p>The machine has a Turbo function with 5 beating speeds from low to high, helping you
                                easily
                                choose the speed to suit each different type of ingredient. Combining beneficial
                                adjustment
                                buttons on the machine's body helps you operate easily and quickly.</p>
                            <li>Strong company, safe materials</li>
                            <p>In particular, the Philips handheld plane operates with a fairly high capacity of 300W,
                                and the
                                motor makes no noise when operating. The tool helps you perfect, mix faster, more evenly
                                and
                                softer. Besides, the body is made of sturdy plastic and the mixing bars are made of
                                high-quality, non-toxic stainless steel, ensuring absolute safety for your family's
                                health.</p>
                            <li>Equipped with two benefits</li>
                            <p>In particular, included with the Phillips HR3705 egg are 2 types of mixing rods that
                                users can
                    ...
                    <div class="pr-i3">
                        ...
                        <div class="container_information">
                            ...
                            <div class="text_product">
                                Taque earum rerum hic tenetur a sapiente maiores alias consequatur aut perferendis
                                doloribus
                                asperiores...
                            </div>
