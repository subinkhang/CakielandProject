    ...
    <div class="container">
        <div class="row">
                ...
                <form action="" onsubmit="checkPasswordLength()">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-6" class="email_box">
                            <input id="Email" type="text" placeholder="Email/Phone number" class="box1signin"> <br>
                        </div>
                        <div class="col-2"></div>
                        <div class="col-2"></div>
                        <div class="col-2"></div>
                        ...
                        <div class="col-2 box_eye"><i class="fa-regular fa-eye" onclick="togglePasswordVisibility(this)"></i></div>
                        <div class="col-2"></div>
                    </div>
                    <div class="row">
                        <div class="col-4"></div>
                    ...
                    <div class="row linepw">
                        ...
                        <div class="col-4 checksignin">
                            <p><input type="checkbox" name="Save" id="saveLogin" onchange="saveLogin(this)"> Save Login</p>
                        </div>
            ...
            <div class="col-6 img_signin">
                <img src="{{asset('frontend/images/sign-in-up/c641ce7483c4728b418ba7d5d93a9ddc.jpg')}}" alt="" class="w-100 img">
            </div>
        </div>
    </div>
</body>
