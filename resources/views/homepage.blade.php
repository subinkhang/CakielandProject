...
@section('homepage')
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p class="text_overlay_p">From selecting the finest ingredients to mastering the techniques
                                    of
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-5">
                                ...
                                <p class="text_overlay_p">The mixing process involves a delicate balance of combining dry
                                    and
    ...
    <div class="marquee">
        <marquee direction="right">Download our new app today! Dont miss our mobile-only offers and shop with Android Play.
        </marquee>
    </div>
